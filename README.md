...
**Junior Web Developer** training at [Factoría F5](https://factoriaf5.org) in Asturias, Spain.
I build web apps with **JavaScript, HTML and CSS**, and I care about writing clean, **tested** code.

- 🎯 Open to my first **junior developer** role (Spain · remote in Europe)
- 🌱 Currently learning: modern JavaScript, web accessibility and automated testing
- 💬 Ask me about: vanilla JS, responsive layouts, Git workflow

## 🛠️ Tech & tools

`JavaScript (ES Modules)` · `HTML5` · `CSS3` · `Vitest` · `Playwright` · `Git & GitHub` · `GitHub Pages` · `Figma` · `Jira`
...
- 📧 iuliantim21@gmail.com
- 💼 LinkedIn https://www.linkedin.com/in/iulian-tim-06a816242/
- 📍 Oviedo, Spain
